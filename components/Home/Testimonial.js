...
const Testimonial = ({ text, employeeName, companyName, companyLink, post, index, picture }) => {
    ...
    return (
        <div className="bg-white rounded-xl relative p-8 flex flex-col justify-between lg:h-43rem lg2:h-38rem lg3:h-33rem xl:h-112 xl2:h-26rem xl3:h-24rem 2xl:h-22rem ">
