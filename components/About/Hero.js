    ...
    return (
        <div>
            <div className={styles.hero}>
                <h1 className="font-bold text-vert-green max-w-xl text-4xl leading-tight lg:leading-snug lg:text-5xl">Our Mission is to help Patient-Centric Health Tech Go Global</h1>
            </div>
            <div className="bg-vert-green-medium max-w-2xl p-8 rounded-2xl mx-5 lg:mr-0 lg:ml-20 -mt-20 lg:-mt-8 lg:mb-32">
                <p className="text-xl text-vert-green font-bold">
                    We believe that health technology has the biggest potential positive impact on how we live our lives across
